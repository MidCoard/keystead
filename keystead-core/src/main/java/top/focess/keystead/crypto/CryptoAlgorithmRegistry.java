...
public final class CryptoAlgorithmRegistry {
    ...
    public static final @NonNull String AEAD_AES_256_GCM = "AES-256-GCM";

    /** Approved AEAD algorithm name for ChaCha20-Poly1305. */
    public static final @NonNull String AEAD_CHACHA20_POLY1305 = "CHACHA20-POLY1305";

    /** Approved KDF algorithm name for PBKDF2-HMAC-SHA-256. */
    public static final @NonNull String KDF_PBKDF2_HMAC_SHA256 = "PBKDF2WithHmacSHA256";
    ...
    public static final @NonNull String DEVICE_TINK_DEVICE_KEY_PACKAGE = "TINK_DEVICE_KEY_PACKAGE";
